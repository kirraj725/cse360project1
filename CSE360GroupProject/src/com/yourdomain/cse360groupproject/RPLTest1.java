...
public class RPLTest1 extends Application
{
	@Override
	public void start(Stage primaryStage)
	{
		...
		Label instructionLabel = new Label("Please fill out the one-time password and enter your username and new password.");
		
		// Invitation code label and field for input
		Label invitationCodeLabel = new Label("One-time password:");
        ...
        primaryStage.setTitle("Reset Password Login");
