...
class DatabaseHelper {
	...
	public void storeArticle(String title, String authors, String theAbstract, String keywords, String body, String references) throws Exception {
		...
		String encryptedAbstract = Base64.getEncoder().encodeToString(encryptionHelper.encrypt(theAbstract.getBytes(), EncryptionUtils.getInitializationVector(title.toCharArray())));
		...
		try (PreparedStatement pstmt = connection.prepareStatement(insertArticle)) {
			pstmt.setString(1, title);  // Title is not encrypted
	...
	public void displayAllArticles() throws Exception {
	    ...
	    while (rs.next()) {
	        ...
	        System.out.print(encryptedAuthors + "\n");
	...
	public void writeArticlesToFile(String fileName) throws Exception {
	    ...
	    try (BufferedWriter writer = new BufferedWriter(new FileWriter(fileName))) {
	        ...
	        writer.write("ID,Title,Authors,Abstract,Keywords,Body,References");
	        writer.newLine();
