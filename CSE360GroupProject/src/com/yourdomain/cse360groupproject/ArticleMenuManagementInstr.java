...
public class ArticleMenuManagementInstr extends Application
{
	@Override
	public void start(Stage primaryStage)
	{
        ...
        vbox.getChildren().addAll(headingLabel, createArtButton, updateArtButton, viewArtButton, delArtButton, listArtButton, backButton);
